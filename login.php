...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark shadow-lg fixed-top">
        <div class="container-fluid">
            ...
            <a href="index.html" style="color: rgb(48, 82, 236); font-size: medium">Informasi Seputar Beasiswa</a>
            </a>
            ...
            <ul class="navbar-nav me-auto m-sm-auto">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="beadn.html">Dalam Negeri</a></li>
                    <li><a class="dropdown-item" href="bealn.html">Luar Negeri</a></li>
                </ul>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="komunitas.html">FORUM</a>
                </li>
                <li class="nav-item">
    ...
    <form action="userlog.php" method="post">
        ...
        <div  iv class="form-login mb-3">
            ...
            <i>belum memiliki akun?
                <a class="form-link" href="learn.html">cara registrasi</a>
            </i><br>
...
<footer class="bg-dark text-white pt-4 pb-4">
    ...
    <div class="row text-center text-md-left">
        ...
        <p>
            <a href="motivasi.html" class="text-white" style="text-decoration: none;">Motivasi</a>
        </p>
        <p>
            <a href="beadn.html" class="text-white" style="text-decoration: none;">Beasiswa Dalam Negeri</a>
        </p>
        <p>
            <a href="bealn.html" class="text-white" style="text-decoration: none;">Beasiswa Luar Negeri</a>
        </p>
        <p>
            <a href="komunitas.html" class="text-white" style="text-decoration: none;">Forum</a>
        </p>
        <p>
            <a href="faq.html" class="text-white" style="text-decoration: none;">FAQ</a>
        </p>
        </div>
